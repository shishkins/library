-- https://github.com/MichaelDBA/pg_get_tabledef.git

CREATE OR REPLACE FUNCTION public.pg_get_tabledef(in_schema character varying, in_table character varying, _verbose boolean, VARIADIC arr tabledefs[] DEFAULT '{}'::tabledefs[])
 RETURNS text
 LANGUAGE plpgsql
AS $function$
  DECLARE
...
ALTER FUNCTION public.pg_get_tabledef(in varchar, in varchar, in bool, variadic _tabledefs) OWNER TO "engineer";
